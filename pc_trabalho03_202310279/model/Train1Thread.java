...
public class Train1Thread extends Thread {
   ...
   * ***************************************************************
   * Metodo: run
   * Funcao: Metodo que e chamado quando a thread e iniciada, iniciando o timer de movimento do trem 1
   * Parametros: nenhum
   * Retorno: nenhum
   */
  public void run() {
      ...
      case 0:{
        ...
        if (this.getTremImagem().getLayoutY() >= 97 && this.getTremImagem().getLayoutY() < 160) {
         ...
         if (this.getTremImagem().getLayoutY() >= 435 && this.getTremImagem().getLayoutY() < 500) {
          ...
          if (!entrouNaZonaCritica2(solucao) && !zonaCritica2 && Train2Thread.zonaCritica2) {
    ...
    switch (solucao) {
      ...
      case 1:{//Estrita alternancia para a zona critica 1
        ...
        if (ControllerTela2.turno1EA == 1) {
          // if que verifica se o turno da zona critica 1 eh do trem 1, caso nao seja o trem nao entra na zona critica 1 ate ele receber o turno, essa variavel eh criada como um recurso compartilhado para controlar a entrada na zona critica 1
          return false;
        }else{
    ...
    switch (solucao) {
      ...
      case 1:{//Estrita alternancia para a zona critica 2
        ...
        if (ControllerTela2.turno2EA == 1) {
          // if que verifica se o turno da zona critica 2 eh do trem 1, caso nao seja o trem nao entra na zona critica 2 ate o turno ser passado a ele, essa variavel eh criada como um recurso compartilhado para controlar a entrada na zona critica 2
          return false;
        }else{
          zonaCritica2 = true;
          // caso o turno da zona critica 2 seja do trem 1, o trem entra na zona critica 2
          return true;
        }
