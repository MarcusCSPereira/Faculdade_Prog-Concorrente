...
public class Train2Thread extends Thread {
    ...
    public static volatile boolean zonaCritica2 = false;//variavel que controla a entrada e saida do trem na zona critica 2
    ...
    switch (solucao) {
      ...
      case 1:{//Estrita alternancia da zona critica 1
        ...
        if(ControllerTela2.turno1EA == 0){
          // if que verifica se o turno da zona critica 1 eh do outro trem, caso seja o trem nao entra na zona critica 1 ate o turno ser passado para ele, essa variavel eh criada como um recurso compartilhado para controlar a entrada na zona critica 1
          return false;
        }else{
          zonaCritica1 = true;
    ...
    switch (solucao) {
      ...
      case 1:{//Estrita alternancia da zona critica 2
        ...
        if(ControllerTela2.turno2EA == 0){
          // if que verifica se o turno da zona critica 2 eh do trem , caso nao seja o trem nao entra na zona critica 2 ate o turno ser passado a ele, essa variavel eh criada como um recurso compartilhado para controlar a entrada na zona critica 2
          return false;
        }else{
